# About  
mobileFlashCards is a FlashCard-like Quiz app developed to run on 
ios and android.  
It was developed on and tested for use on  https://snack.expo.io/
...
├── components
        ├── AddCardView.js     # Add a card view
        ├── AddDeckView.js     # Add a deck view
        ├── DecksView.js       # Shows the decks screen
        ├── QuizButton.js      # A Button for the Quiz View
        ├── QuizView.js        # Shows a Quiz screen
        ├── SettingsView.js    # Reset DecksView
        └── SingleDeckItem.js  # The View of a Sigle Deck
├── utils
        ├── api.js     # Card and Deck functions 
        ├── colors.js  # Some defalt colors
        └── helpers.js # Clear and set ntofications
